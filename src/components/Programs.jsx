    ...
    <section className="section-padding bg-white overflow-hidden" id="about">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            <span className="text-[var(--primary)] font-bold uppercase tracking-widest text-sm mb-4 block">{t.about.story}</span>
            ...
            <div className="space-y-4 mb-10">
              <div className="flex items-start gap-4">
                <CheckCircle className="text-[var(--primary)] shrink-0 mt-1" size={24} />
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="absolute -inset-4 bg-[var(--primary)]/10 rounded-[3rem] -rotate-3"></div>
            <img 
              src="/assets/about-image.png" 
              alt="TEWOYEI Women Group" 
        ...
        <div id="programs">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[var(--primary)] font-bold uppercase tracking-widest text-sm mb-4 block">Our Work</span>
            <h2 className="text-4xl font-bold font-outfit">Socio-Economic Interventions</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { img: 'skilling.png', title: 'Livelihood & Skilling', desc: 'Providing vocational training in tailoring, bakery, and construction.' },
              { img: 'health.png', title: 'Health & Hygiene', desc: 'Implementing menstrual health and malaria prevention projects.' },
              { img: 'leadership.png', title: 'Leadership & Advocacy', desc: 'Empowering women for active social and political participation.' }
            ].map((program, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <a href="#" className="text-[var(--primary)] font-bold hover:gap-4 transition-all inline-flex items-center gap-2">
